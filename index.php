...
<div class="banner-grid">
  <div id="visual">
      <div class="slide-visual">
        ...
        <ul class="slide-group"  style="margin-left:60px; margin-top:30px;">
          ...
          <li><a href="event.php?id=<?= $rw['id'];?>"><img   width="800" height="600" class="img-responsive" src="images/<?php echo $rw['photo'] ?>" alt="<?php echo $rw['photo'] ?>"  /></a></li>
          <?php } ?>
</ul>       
<!--
...
<div class="product_info">
    <div class="product_name">
      <form  action="addtocart.php" method="post">
        <a id="product"  href="products/adrenalin-potenza-re001.html">Adrenalin Potenza RE001</a>
        <input type="text" hidden name="nomprod" value="Adrenalin Potenza RE001">
    </div>
    ...
    <div class="product_price">
        ...
        <span   id="price" class="money">199 TND</span>
        <input type="text" hidden name="price" value="199">
...
-->
    ...
    <!-- We can leave this in, since the select comes later, 
        ...
        <input type="hidden" name="button1" value="696762915" />
  ...
  <!-- START BUY -->
        ...
        <button class="btn btn-cart" name="button3" type="submit"><i class="fa fa-shopping-cart"></i> Add to cart</button>
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" hidden name="nomprod" value="ATS Classic">
    </div>
    ...
    <div class="product_price">
        ...
        <span class="money">66 TND</span>
         <input type="text" hidden name="price" value="66">
    </div>
    <!-- 
    This is just a regular add product form. 
    You should be able to add any valid input fields to it 
-->
    ...
    <!-- We can leave this in, since the select comes later, 
        ...
        <input type="hidden"  name="button2" value="696762959" />
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" value="Bridgestone Turanza ER300 Ecopia" hidden name="nomprod">
    </div>
    ...
    <div class="product_price">
        ...
        <span class="money">320.00DT</span>
              <input type="text" value="320" hidden name="price">
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" hidden name="nomprod" value="Ats Cup">
    </div>
    ...
    <div class="product_price">
        ...
        <input type="text" hidden name="price" value="78">
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" hidden name="nomprod" value="Bridgestone Potenza RE050A">
    </div>
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" hidden name="nomprod" value="ATS DTM Competition">
    </div>
    ...
    <div class="product_price">
        ...
        <span class="money">399.00DT</span>
              <input type="text" hidden name="price" value="399">
...
<div class="product_info">
    <div class="product_name">
        ...
        <input type="text" name="nomprod" hidden value="Bridgestone Turanza ER30"> 
    </div>
    ...
    <div class="product_price">
        ...
        <input type="text" name="price" hidden value="170">
...
<div class="product_info">
    <div class="product_name">
      <form  action="addtocart.php" method="post">
        ...
        <input type="text" name="nomprod" hidden value="Excelsior Stahl-Sport 17-E55-A1">
    </div>
    ...
    <div class="product_price">
        ...
        <span class="money">60.00DT</span>
         <input type="text" name="price" hidden value="60">
