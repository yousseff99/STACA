...
<div class="product_info">
    <div class="product_name">
        <a href="accessories/products/ats-classic.html"><?PHP echo $row['nom']; ?></a>
         <input type="text" hidden name="nomprod" value="<?PHP echo $row['nom']; ?>">
    </div>
...
if ($prix!=-1){
  ...
  <span class="product-new-top" style="color: yellow">In Promotion</span>  

    <span class="product-new-top" style="margin-right: 85%; color: yellow"> <?php echo $taux; ?> % </span><br>     
        <span class="money"><?PHP echo $prix; ?> TND <br><del> <?PHP echo $row['prix']; ?>    TND  </del></span>

<?php } else { ?>

<span class="money"> <?PHP echo $row['prix']; ?>    TND  </span><?php } ?>
 <input type="text" hidden name="price" value="<?PHP echo $row['prix']; ?>">
